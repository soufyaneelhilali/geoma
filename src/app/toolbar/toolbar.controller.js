(function ()
{
    ...
    /** @ngInject */
    function ToolbarController($rootScope,api,$scope,sessionService, $q, $state, $timeout, $mdSidenav, $translate, $mdToast, msNavigationService)
    {
        var vm = this;
        ...
        function changeLanguage(lang)
        {
            ...
            if ( lang.code !== 'en' )
            {
                var message = 'GeoMa prend en charge les traductions, mais actuellement, nous n\'avons aucune traduction autre que la langue Francaise. les autres langues seron disponible prochainement.';
