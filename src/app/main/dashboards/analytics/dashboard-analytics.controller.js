(function ()
{
    ...
    /** @ngInject */
    function DashboardAnalyticsController($timeout,DashboardData,api,sessionService,$http,$resource,notifyService)
    {
        var vm = this;
        ...
        vm.crnt_userid = sessionService.get('id');

        $http({
        method: 'GET',
        url: api.url+'maps?where=user_id,'+vm.crnt_userid+'&count=true'
            }).then(function successCallback(response) {
             vm.countmymaps = response.data ;
            });

        $http({
        method: 'GET',
        url: api.url+'upfiles?where=user_id,'+vm.crnt_userid+'&count=true'
            }).then(function successCallback(response) {
             vm.countmyfiles = response.data ;
            });

        $http({
        method: 'GET',
        url: api.url+'upfiles?count=true'
            }).then(function successCallback(response) {
             vm.countfiles = response.data ;
            });

        $http({
        method: 'GET',
        url: api.url+'maps?count=true'
            }).then(function successCallback(response) {
             vm.countmaps = response.data ;
            });

        $http({
        method: 'GET',
        url: api.url+'layers?count=true'
            }).then(function successCallback(response) {
             vm.countlayers = response.data ;
            });

        $http({
        method: 'GET',
        url: api.url+'layers?where=user_id,'+vm.crnt_userid+'&count=true'
            }).then(function successCallback(response) {
             vm.countmylayers = response.data ;
            });

        $http({
        method: 'GET',
        url: api.url+'users?count=true'
            }).then(function successCallback(response) {
             vm.countusers = response.data ;
            });

/*        $http({
        method: 'GET',
        url: api.url+'files?count=true'
            }).then(function successCallback(response) {
             vm.countfiles = response.data ;
            });
        $http({
